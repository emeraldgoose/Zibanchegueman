...
app.controller('ModalInstanceCtrl', function ($http, $location, $uibModalInstance, $uibModal, demoApp, apiBaseURL, peers) {
    ...
    modalInstance.create = () => {
        if (invalidFormInput()) {
            ...
            const createIOUEndpoint = `${apiBaseURL}create-iou?peer=${modalInstance.form.peer}&from=${modalInstance.form.from}&to=${modalInstance.form.to}&amount=${modalInstance.form.amount}&date=${modalInstance.form.date}`;
